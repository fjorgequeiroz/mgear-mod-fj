...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.jntDivisions_label = QtWidgets.QLabel(self.groupBox)
        self.jntDivisions_label.setObjectName("jntDivisions_label")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.jntDivisions_label)
        self.jntDivision_spinBox = QtWidgets.QSpinBox(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.jntDivision_spinBox.sizePolicy().hasHeightForWidth())
        self.jntDivision_spinBox.setSizePolicy(sizePolicy)
        self.jntDivision_spinBox.setMinimum(3)
        self.jntDivision_spinBox.setProperty("value", 3)
        self.jntDivision_spinBox.setObjectName("jntDivision_spinBox")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.jntDivision_spinBox)
        self.centralTangent_label = QtWidgets.QLabel(self.groupBox)
        self.centralTangent_label.setObjectName("centralTangent_label")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.centralTangent_label)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.centralTangent_checkBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.jntDivisions_label.setText(gqt.fakeTranslate("Form", "Joint Divisions", None, -1))

...
class Component(component.Main):
    ...
    def addObjects(self):
        ...
        # Tangent controllers -------------------------------
        # Guide curvature: tangent handle positions come directly from
        # the guide's tan0/tan1 locators (S-shape guide), instead of
        # being auto-interpolated between root and eff (spine_FK_01).
        if self.settings["centralTangent"]:
            ...
            # Tangent mid control
            vec_pos = vector.linearlyInterpolate(self.guide.pos["tan0"],
                                                 self.guide.pos["tan1"],
                                                 .5)
            t = transform.setMatrixPosition(t, vec_pos)
    ...
    def addOperators(self):
        ...
        # Tangent position ---------------------------------
        # common part
        d = vector.getDistance(self.guide.pos["root"], self.guide.pos["eff"])

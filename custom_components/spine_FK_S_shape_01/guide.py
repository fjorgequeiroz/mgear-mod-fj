...
EMAIL = ", "
VERSION = [1, 0, 0]
TYPE = "spine_FK_S_shape_01"
NAME = "spine"
DESCRIPTION = "FK Spine with an S-shape guide (root, two tangent " \
              "handles and eff) so the guide curvature can be shaped " \
              "before building, same as 'spine_S_shape_01', but the " \
              "built rig behaves like 'spine_FK_01' (FK chain riding " \
              "on the guide curve, no autoBend/IKWorldOri)."
...
class Guide(guide.ComponentGuide):
    ...
    def get_divisions(self):
        ...
        self.divisions = self.root.jntDivision.get()

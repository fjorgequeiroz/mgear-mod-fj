...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.chickenStyle_label = QtWidgets.QLabel(self.fkRefArray_groupBox)
        ...
        self.chickenStyleIK_checkBox = QtWidgets.QCheckBox(self.fkRefArray_groupBox)
        ...
        self.gridLayout_3.addLayout(self.fkRefArray_horizontalLayout, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.fkRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "FK Base Reference Array", None, -1))
        self.chickenStyle_label.setText(gqt.fakeTranslate("Form", "Chicken style IK", None, -1))
        self.chickenStyleIK_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>If <span style=\" font-weight:600;\">checked</span>, the FK base reference connects rotation <span style=\" font-weight:600;\">and</span> translation - useful for <span style=\" font-weight:600;\">chicken</span> / bird style neck pinning.</p><p><span style=\" font-weight:600;\">Unchecked</span> connects only the rotation - regular human neck.</p></body></html>", None, -1))
        self.fkRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "Copy from Head Ref", None, -1))
        ...
        self.headRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "Copy from FK Ref", None, -1))

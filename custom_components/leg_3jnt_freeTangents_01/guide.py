"""Guide leg 3jnt free tangents 01 module"""

from functools import partial

from mgear.shifter.component import guide
from mgear.core import transform, pyqt, attribute, upv_visualizer
...
EMAIL = ""
VERSION = [1, 0, 0]
TYPE = "leg_3jnt_freeTangents_01"
NAME = "leg"
DESCRIPTION = (
    "3 bones leg (quadrupeds / animals) with the free-tangent deformation "
    "system of leg_2jnt_freeTangents_01: spline-IK twist chains shaped by "
    "per-segment tangent controls instead of the roundness attributes. "
    "Divisions kept (div0 / div1 / div2). Pin Elbow reference array for "
